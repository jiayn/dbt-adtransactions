...
from {{ ref('_adtransactions_aggregated_to_media_bckt_accgroup_front') }} as front
full join {{ ref('_adtransactions_aggregated_to_media_bckt_accgroup_back') }} as back 
on
...
left join {{ ref('stg_glaucus__rta_bckt_accgroup_config') }} as stgy 
